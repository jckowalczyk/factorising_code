...
pop_desnity = pd.read_csv("../data/population_density_2019.csv") # ../ results in one folder above the current
locations = pd.read_csv("../data/locations.csv")

# preview 

print(pop_desnity_df.head())
...
pop_density[["country_code", "parent_code"]] = (pop_density["country_and_parent_code"].str.split("_", expand=True))
